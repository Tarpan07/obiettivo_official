...
async function resolveFont(font: string, fontUrl?: string | null): Promise<string> {
...
class Media {
    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          p.z = (sin(p.x * 4.0 + uTime) * 1.5 + cos(p.y * 2.0 + uTime) * 1.5) * (0.015 + uSpeed * 0.45);
  ...
  onResize(sizes?: { screen?: any; viewport?: any }) {
    if (sizes) {

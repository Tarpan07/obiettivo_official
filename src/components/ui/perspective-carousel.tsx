              ...
              >
                ...
                >
                  <button
                    ...
                    className="aspect-[3/4] w-full cursor-pointer focus:outline-none"
                  ...
                  >
                    ...
                    <img
                      ...
                      draggable={false}
                      className={cn(
                        "h-full w-full select-none rounded-lg object-cover shadow-xl transition-all duration-300",
                        isActive ? "ring-2 ring-blue-500/50" : "opacity-45 hover:opacity-75",
                        imageClassName
                      )}
                    />
                  </button>
                  ...
                  <motion.p
                    className={cn("whitespace-nowrap text-xs font-medium tracking-wide uppercase font-[family-name:var(--font-sora)]", isActive ? "text-zinc-200" : "text-zinc-600", labelClassName)}
                    animate={{
              ...
              {items.map((item, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    currentIndex === index ? "w-7 opacity-100 bg-blue-500" : "w-2 opacity-30"
                  )}
                  onClick={() => selectSlide(index)}
                />
              ))}
